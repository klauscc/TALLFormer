...
def get_config():
    ...
    parser.add_argument("config_file", type=str, default="configs/default.yaml", nargs="?")
    ...
    parser.add_argument("--addi_config", help="additional config file")
    parser.add_argument("--classifier", help="the action classifier", type=str)
    ...
    ## additional config
    if os.path.isfile(args.addi_config):
        other_config = Config.fromfile(args.addi_config)
